...
#length function will return an integer value so we can assign
#integer variables using length function
length_of_the_str= len(str)
print(length_of_the_str)
print(type(length_of_the_str))


#create a programm to print True if the length of the string even number
