...
ave_score=int (exam1*20/100 + exam2*30/100 + exam3*50/100)

is_attendancy_enough=attendancy>=80
is_ave_score_enough=ave_score>=65

can_pass=is_attendancy_enough and is_ave_score_enough
print("Average score of the student", ave_score)
print("Attendancy of the student is", is_attendancy_enough)
print("Student can the class", can_pass)
